...
public class NowPlayingTask extends AsyncTaskLoader<ArrayList<MovieItem>> {
    ...
    public NowPlayingTask(final Context context, String listM) {
        super(context);
    ...
    public ArrayList<MovieItem> loadInBackground() {
        ...
        String url = "https://api.themoviedb.org/3/movie/now_playing?api_key=" + API_KEY + "&language=en-US&query=" + mlistM;
        Log.e("url", url + "");
